...
locals {
  base_image = "us-central1-docker.pkg.dev/gfw-int-infrastructure/pipeline-core/pipe-naf-reader"
}

resource "google_cloudbuild_trigger" "pipe_naf_reader_trigger_tag" {
  name     = "pipe-naf-reader-tag"
